        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ContactInfo = table.Column<string>(type: "nvarchar(1500)", maxLength: 1500, nullable: true),
                    Address = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    Phone = table.Column<string>(type: "nvarchar(15)", maxLength: 15, nullable: true),
                    Email = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    WorkTime = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CategoryToProducts_ProductCategories_CategoryId",
                        column: x => x.CategoryId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductComments_Commenters_CommenterId",
                        column: x => x.CommenterId,
                        principalTable: "Commenters",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SizeToProducts", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ColorToSizeToProducts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ColorToSizeToProducts_Colors_ColorId",
                        column: x => x.ColorId,
                        principalTable: "Colors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ColorToSizeToProducts_SizeToProducts_SizeToProductId",
                        column: x => x.SizeToProductId,
                        principalTable: "SizeToProducts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Price = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    Quantity = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    ColorToSizeToProductId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SaleItems_ColorToSizeToProducts_ColorToSizeToProductId",
                        column: x => x.ColorToSizeToProductId,
                        principalTable: "ColorToSizeToProducts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ColorToSizeToProducts_ColorId",
                table: "ColorToSizeToProducts",
                column: "ColorId");

            migrationBuilder.CreateIndex(
                name: "IX_ColorToSizeToProducts_SizeToProductId",
                table: "ColorToSizeToProducts",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductComments_CommenterId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SaleItems_ColorToSizeToProductId",
                table: "SaleItems",
                column: "ColorToSizeToProductId");
